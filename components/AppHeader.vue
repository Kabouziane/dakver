  ...
  <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <!-- Logo -->
        <NuxtLink :to="homePath" class="flex items-center gap-2.5 group" aria-label="Accueil">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 -mt-0.5 hidden sm:block">{{ l.tagline }}</p>
          </div>
        </NuxtLink>
        ...
        <div class="flex items-center gap-2">
          <LanguageSwitcher />
          <NuxtLink :to="contactPath" class="hidden sm:inline-flex btn-primary text-sm py-2 px-4">
            {{ l.cta }}
          </NuxtLink>
          <button
    ...
    >
      <nav v-if="mobileOpen" class="lg:hidden border-t border-gray-100 bg-white px-4 py-3 space-y-1">
        ...
        <div class="pt-2 border-t border-gray-100">
          <NuxtLink :to="contactPath" class="btn-primary w-full text-sm py-3" @click="mobileOpen = false">
            {{ l.cta }}
          </NuxtLink>
        </div>
      </nav>
...
const labels = {
  fr: {
    tagline: 'Bruxelles · Toute la Belgique',
    home: 'Accueil', services: 'Services', techniques: 'Techniques & Effets',
    subsidies: 'Subsides', portfolio: 'Réalisations', contact: 'Contact',
    cta: 'Devis gratuit',
  },
  nl: {
    tagline: 'Brussel · Heel België',
    home: 'Home', services: 'Diensten', techniques: 'Technieken & Effecten',
    subsidies: 'Subsidies', portfolio: 'Realisaties', contact: 'Contact',
    cta: 'Gratis offerte',
  },
  en: {
    tagline: 'Brussels · All of Belgium',
    home: 'Home', services: 'Services', techniques: 'Techniques & Effects',
    subsidies: 'Subsidies', portfolio: 'Projects', contact: 'Contact',
    cta: 'Free Quote',
  },
}
...
const navLinks = computed(() => {
  ...
  const lv = l.value
  return [
    { to: homePath.value,          name: lv.home },
    { to: `${p}/services`,         name: lv.services },
    { to: `${p}/techniques`,       name: lv.techniques },
    { to: `${p}/subsides`,         name: lv.subsidies },
    { to: `${p}/realisations`,     name: lv.portfolio },
    { to: `${p}/contact`,          name: lv.contact },
  ]
})
